                ...
                <div className="grid md:grid-cols-2 gap-12 items-center">
                    <div className="fade-in-up">
                        ...
                        <p className={`text-lg mb-8 ${isDark ? 'text-gray-400' : 'text-gray-500'}`}>
                            ...
                            1+ year of experience delivering production-ready systems with 99.9% uptime.
                        </p>
                        ...
                        <div className={`flex space-x-4 ${isDark ? 'text-white' : 'text-gray-700'}`}>
                            <a href="https://github.com/Shivam-Shukla96" target="_blank" rel="noopener noreferrer" className="p-3 glass rounded-lg hover:scale-110 transition-all duration-300 ">
                                <Github size={24} />
                            </a>
                            <a href="https://www.linkedin.com/in/shivamshukla96/" target="_blank" rel="noopener noreferrer" className="p-3 glass rounded-lg hover:scale-110 transition-all duration-300">
                                <Linkedin size={24} />
                            </a>
                            <a href="https://leetcode.com/u/cvmsucla/" target="_blank" rel="noopener noreferrer" className="p-3 glass rounded-lg hover:scale-110 transition-all duration-300">
                                <span className="text-sm font-medium ">Leet</span>
                            </a>
                            <a href="tel:+916307687424" className="p-3 glass rounded-lg hover:scale-110 transition-all duration-300">
                                <Phone size={24} />
                            </a>
                        </div>
                    </div>
